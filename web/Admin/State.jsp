...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <%
        ...
        if (request.getParameter("id") != null) {
            String del = "delete from tbl_state where state_id = '" + request.getParameter("id") + "'";
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><a href="State.jsp?id=<%=rs.getString("state_id")%>" class="status_btn">Delete</a></td>                                     
                                            </tr>
                                            <%
                                                }
