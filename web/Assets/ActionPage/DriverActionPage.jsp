    ...
    <body>
        ...
        <%
            ...
            if (isMultipart) {
                ...
                while (itr.hasNext())//checking if there is any value in the position like rs.next()
                {
                    ...
                    } else//when it is an image or multipart
                    {
                        ...
                        if (field_name.equals("file_photo"))//write the name of image here it is img_product
                        {
                            ...
                            logo = "DriverPhoto_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
                ...
                String InsQry = "insert into tbl_bus_service(bs_name,bs_contact,bs_email,bs_photo,bs_password,place_id)"
                        + "values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + logo + "','" + value[6] + "','" + value[5] + "')";
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../Admin/NewDriver.jsp'
            }, 40);
        </script>
        <%
                }
