    ...
    <body>
        ...
        <%
            ...
            if (isMultipart) {
                ...
                while (itr.hasNext())//checking if there is any value in the position like rs.next()
                {
                    ...
                    } else//when it is an image or multipart
                    {
                        ...
                        if (field_name.equals("file_photo"))//write the name of image here it is img_product
                        {
                            ...
                            logo = "UserPhoto_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
                ...
                String InsQry = "insert into tbl_user(user_name,user_contact,user_photo,user_email,user_password)"
                        + "values('" + value[0] + "','" + value[1] + "','" + logo + "','" + value[2] + "','" + value[3] + "')";
