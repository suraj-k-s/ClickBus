        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7">
            <div class="mb-4">
              ...
              <form method="post" enctype="multipart/form-data" action="Assets/ActionPage/UserActionPage.jsp">
             <div class="form-group">
              ...
              <div class="d-flex mb-5 align-items-center">
                <label class="control control--checkbox mb-0">
                 ...
                 <span align="left"><a href="Login.jsp" class="forgot-pass" style="left:-29px">Sign In</a></span> 
