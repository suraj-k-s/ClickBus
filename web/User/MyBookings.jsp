...
<html lang="en">
  ...
  <body>
    ...
    <div class="page-wrapper bg-img-2 p-t-25 p-b-120"> 
      <div class="nav-bar">
        <div class="nav-heading" style="margin-right:220px">Click Bus</div>
        <div class="insta-default">
        <a href="HomePage.jsp" class="insta-default">Home</a>
        <a href="MyBookings.jsp" class="insta-default">Bookings</a>
          <a href="../Login.jsp" class="insta-default">Log Out</a>
        </div>
      </div>
       ...
       <div class="card card-5">
          <div class="card-body">
            <div class="row row-space">
          		<iframe style="border: none; border-radius: 15px; width: 100%; height: 653px ;" src = "Booking.jsp" ></iframe>
      		</div>
      	  </div>
   		</div>
      </div>
